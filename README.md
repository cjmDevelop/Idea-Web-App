...
## Future Features
Going to add backend and rdbms to make this a complete fullstack portfolio project, backend tech stack should include: Java | Spring/Spring-Boot | Postgresql/SQL
